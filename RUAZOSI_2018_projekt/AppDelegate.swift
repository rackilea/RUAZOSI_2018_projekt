...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        // Vise ne postavljamo RealInitalViewController kao 'rootViewController' aplikacije, vec UINavigationController
        // U UINavigationController postavljamo RealInitalViewController kao pocetni ViewController na stogu
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "RUAZOSI_projekt")
